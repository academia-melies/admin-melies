...
import { DataFilters, FetcherData, FiltersField, Receiveds } from "../..";
...
interface HeaderFiltersProps {
    ...
    setReceived: Dispatch<SetStateAction<Receiveds[]>>
...
const HeaderFilters: React.FC<HeaderFiltersProps> = ({
    ...
    const fields: Fields[] = [
        ...
        { label: 'Tipo de Conta', value: 'account' },
    ]
    ...
    return (
        <Box sx={{ display: 'flex', gap: 1, justifyContent: 'space-between', padding: '20px 20px 10px 25px', }}>
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
                ...
                {isPermissionEdit &&
                    <Link href={'/financial/billsToReceive/billsReceived/new'} target="_blank" style={{display: 'flex'}}>
                        <ButtonIcon
                            text="Novo"
