...
import { Box, Button, ContentContainer, Divider, FileInput, PhoneInputField, Text, TextInput } from "../../../../../atoms"
import { EditFile } from "../../[id]"
import { Avatar, Backdrop } from "@mui/material"
import { CheckBoxComponent, RadioItem, SelectList } from "../../../../../organisms"
import { useAppContext } from "../../../../../context/AppContext"
import { formatCEP, formatCPF, formatRg, formatTimeStamp } from "../../../../../helpers"
...
const UserData = ({
    ...
    const { colorPalette, alert, setLoading, loading, matches } = useAppContext()

    const fetchData = async () => {
        try {
            const [userResponse, dependentResponse, disciplineResponse, permissionsResponse, disciplinesResponse, countriesResponse] = await Promise.all([
                api.get(`/user/${id}`),
    ...
    return (
        <>
            ...
            <ContentContainer style={{ ...styles.containerRegister, padding: '40px' }}>
                <Box sx={{
