   ...
   return (
      <Typography
         ...
         sx={{
            ...
            fontSize: { xs: `12px`, xm: `12px`, md: `12px`, lg: `13px`, xl: '13px' },
            ...
            ...(large && { fontSize: { xs: `14px`, sm: `14px`, md: `14px`, lg: `15px`, xl: `16px` } }),
            ...(veryLarge && { fontSize: { xs: `22px`, sm: `18px`, md: `18px`, lg: `18px`, xl: `25px` } }),
            ...(indicator && { fontSize: { xs: `22px`, sm: `25px`, md: `25px`, lg: `28px`, xl: `28px` } }),
            ...(title && { fontSize: { xs: `18px`, sm: `18px`, md: `18px`, lg: `18px`, xl: `21px` } }),
